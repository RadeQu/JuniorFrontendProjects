...
var today = curDate.getDay();

var _loop = function _loop(i) {
  bars[i].style.height = "".concat(data[i].amount, "%");
  bars[today - 1].style.background = "hsl(186, 34%, 60%)";
  bars[i].addEventListener("mouseenter", function () {
    bars[i].setAttribute("data-content", "$".concat(data[i].amount));
    bars[i].style.background = "hsl(10, 79%, 65%, 0.5)";
  });
  bars[today - 1].addEventListener("mouseenter", function () {
    bars[today - 1].style.background = "hsl(186, 34%, 60%, 0.5)";
  });
  bars[today - 1].addEventListener("mouseleave", function () {
    bars[today - 1].style.background = "hsl(186, 34%, 60%)";
  });
